            ...
            throws ServletException, IOException
    {
        ...
        else if (action.equals("/transaction"))
        {
            ...
            if(request.getParameter("amount") == null){
            	out.write("<script>window.alert('Please enter amount!!');</script>");
				rd = request.getRequestDispatcher("/home.jsp");
				rd.include(request,response);
            }
           
            if (request.getParameter("rbtnUserService").equals("deposit"))
            {
                ...
                Receipt re = new Receipt(acc_id, acc.getName(), acc.getBalance(), oldBal, myDate,
                        "D");
                try
                {
            ...
            else if (request.getParameter("rbtnUserService").equals("withdraw"))
            {
                double amount = Double.parseDouble(request.getParameter("amount"));
                long acc_id = Long.parseLong(request.getParameter("AccountNum"));
                Account acc = accDao.retrieveAccountByAccId(acc_id);
                ...
                else
                {
                    ...
                    Receipt re = new Receipt(acc_id, acc.getName(), acc.getBalance(), oldBal,
                            myDate, "D");
                    try
                    {
                        reDao.createReceipt(re);
            ...
            {
            	out.write("<script>window.alert('Please select deposit');</script>");
				rd = request.getRequestDispatcher("/home.jsp");
				rd.include(request,response);
            }
        }
